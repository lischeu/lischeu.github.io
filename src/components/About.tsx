  ...
  return (
    <>
      <section id="about" className="min-w-screen min-h-screen flex flex-col items-center justify-center gap-4">
        <article className="h-auto items-center rounded p-4 space-y-4 bg-dust md:w-1/2">
          <h1>Hi, I'm Lisa!</h1>
          <p>
        ...
        <article className="tool-icons bg-dust p-4 grid grid-cols-4 gap-2 text-center">
